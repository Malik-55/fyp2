...
export const BookingDetail = ({ navigation, route }) => {
        ...
        <ScrollView>
            <View style={styles.container} >
                ...
                <View style={{ width: '90%', alignSelf: 'center', marginVertical: 12 }}>
                    ...
                    <Text style={{ color: '#FFFFFF', fontSize: 10, opacity: 0.8 }}>Owner:</Text>

                    <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', }} >
                        <Image source={ICONS.profileA} style={{ width: 15, height: 15 }} />
                        <Text style={{ fontSize: 14, color: '#FFFFFF', }}> {data.userDetail.fullName}</Text>
                    </View>
                    <Text style={{ color: '#FFFFFF', fontSize: 14 }} >Contact: <Text style={{ fontWeight: 'bold' }} >{data.userDetail.email}</Text></Text>
                    ...
                    {
                        data.status == "Pending" && <TouchableOpacity onPress={() => changeStatus("Ongoing")} style={{ width: '100%', backgroundColor: '#efcd39', height: 45, justifyContent: 'center', alignItems: 'center', borderRadius: 5, marginVertical: 35 }} >
                            <Text style={{ color: '#454136', fontSize: 16, fontWeight: 'bold' }} >Accept</Text>
                        </TouchableOpacity>
                    }
                    {
                        data.status == "Ongoing" && <TouchableOpacity onPress={() => changeStatus("Cancel")} style={{ width: '100%', backgroundColor: '#efcd39', height: 45, justifyContent: 'center', alignItems: 'center', borderRadius: 5, marginVertical: 35 }} >
